...
import com.rsvmcs.qcrsip.core.log.logRecord.LogRecord;
...
public class ServerLog implements ServerLogger {
    ...
    private void setProperties(Properties configurationProperties) {
        ...
        this.description = configurationProperties.getProperty("com.rsvmcs.qcrsip.STACK_NAME");
        this.stackIpAddress = configurationProperties.getProperty("com.rsvmcs.qcrsip.IP_ADDRESS");
        this.logFileName = configurationProperties.getProperty("com.rsvmcs.qcrsip.SERVER_LOG");
        String logLevel = configurationProperties.getProperty("com.rsvmcs.qcrsip.TRACE_LEVEL");
        String logContent = configurationProperties
                .getProperty("com.rsvmcs.qcrsip.LOG_MESSAGE_CONTENT");
            ...
            if (printWriter == null) {
                boolean overwrite = Boolean.valueOf(
                    configurationProperties.getProperty(
                        "com.rsvmcs.qcrsip.SERVER_LOG_OVERWRITE"));
                ...
                printWriter.println("<!-- "
                        ...
                        + "com.rsvmcs.qcrsip.IP_ADDRESS= "
                        + configurationProperties.getProperty("com.rsvmcs.qcrsip.IP_ADDRESS") + "\n"
                        + "com.rsvmcs.qcrsip.STACK_NAME= "
                        + configurationProperties.getProperty("com.rsvmcs.qcrsip.STACK_NAME") + "\n"
                        + "com.rsvmcs.qcrsip.ROUTER_PATH= "
                        + configurationProperties.getProperty("com.rsvmcs.qcrsip.ROUTER_PATH") + "\n"
                        + "com.rsvmcs.qcrsip.OUTBOUND_PROXY= "
                        + configurationProperties.getProperty("com.rsvmcs.qcrsip.OUTBOUND_PROXY") + "\n"
                        + "-->");
                    ...
                    if (sipStack.isLoggingEnabled(LogWriter.TRACE_DEBUG)) {
                        stackLogger
                                .logDebug("Here are the stack configuration properties \n"
                                        ...
                                        + "com.rsvmcs.qcrsip.ROUTER_PATH= "
                                        + configurationProperties
                                                .getProperty("com.rsvmcs.qcrsip.ROUTER_PATH")
                                        + "\n"
                                        + "com.rsvmcs.qcrsip.OUTBOUND_PROXY= "
                                        + configurationProperties
                                                .getProperty("com.rsvmcs.qcrsip.OUTBOUND_PROXY")
                                        + "\n"
                                        + "com.rsvmcs.qcrsip.CACHE_CLIENT_CONNECTIONS= "
                                        + configurationProperties
                                                .getProperty("com.rsvmcs.qcrsip.CACHE_CLIENT_CONNECTIONS")
                                        + "\n"
                                        + "com.rsvmcs.qcrsip.CACHE_SERVER_CONNECTIONS= "
                                        + configurationProperties
                                                .getProperty("com.rsvmcs.qcrsip.CACHE_SERVER_CONNECTIONS")
                                        + "\n"
                                        + "com.rsvmcs.qcrsip.REENTRANT_LISTENER= "
                                        + configurationProperties
                                                .getProperty("com.rsvmcs.qcrsip.REENTRANT_LISTENER")
                                        + "com.rsvmcs.qcrsip.THREAD_POOL_SIZE= "
                                        + configurationProperties
                                                .getProperty("com.rsvmcs.qcrsip.THREAD_POOL_SIZE")
                                        + "\n");
    ...
    public void logMessage(SIPMessage message, String from, String to, boolean sender, long time) {
        ...
        String firstLine = message.firstLine().trim();
        String inputText = (logContent ? message.encode() : message.encode().toString());
        //?????timestampheader
        logMessage(inputText, from, to, sender, null, firstLine, null, null, time, 0);
    }
    ...
    public void logMessage(SIPMessage message, String from, String to, String status, boolean sender, long time) {
        ...
        String firstLine = message.firstLine().trim();
        String encoded = (logContent ? message.encode() : message.encode().toString());
        //?????timestampheader
        logMessage(encoded, from, to, sender, null, firstLine, status, null, time,  0);
    }
